...
const LandingPage = () => {
  return (
    <div className="fixed rounded-md">
      <div className="border rounded-md">
        <ul className="list-none text-black w-full overflow-x-hidden">
          <li
            className="hover:bg-indigo-500 rounded-sm pl-3 pr-56 py-3 transform cursor-pointer mb-2 
    ...
    //      <li className='hover:bg-indigo-500 rounded-sm pr-3 pr-[233px] py-3 transform cursor-pointer mb-2
